...
const Avalanches = () => {
  ...
  const { isLoading: isLoadingAvalanches, data: avalanchesData } = useQuery<
    Avalanche[],
    Error
  >(['avalanches-week'], () => fetchAvalanches(), {
            ...
            {avalanchesData ? (
              <>
                <div className={s.avalanche__info}>
                  <AvalancheInfo
                    level={
                      (avalanchesData && avalanchesData[index].danger) ?? 0
                    }
            ...
            {avalanchesData ? (
              <>
                <AvalancheInfoItem
                  am={true}
                  elevation={
                    avalanchesData && avalanchesData[index].am.elevation
                  }
                  danger={
                    (avalanchesData && avalanchesData[index].am.danger) ?? []
                  }
                  increase={
                ...
                <AvalancheInfoItem
                  am={false}
                  elevation={
                    avalanchesData && avalanchesData[index].pm.elevation
                  }
                  danger={
                    (avalanchesData && avalanchesData[index].pm.danger) ?? []
                  }
                  increase={
